...
const createContact = async (payload) => prisma.contact.create({ data: payload });
const getAllContacts = async () => prisma.contact.findMany({ orderBy: { createdAt: "desc" } });
...
const updateContact = async (id, payload) => prisma.contact.update({ where: { id }, data: payload });
const deleteContact = async (id) => prisma.contact.delete({ where: { id } });
